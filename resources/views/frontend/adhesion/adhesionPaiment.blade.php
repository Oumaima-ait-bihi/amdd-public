    ...
    <main id="main">
        ...
        <div class="parallax">
            <div class="breadcrumbs" data-aos="fade-in">
                <div class="container">
                    <h2>Etre Membre officiel de AMDD</h2>
            ...
            <div class="row no-gutters">
                <div class="col-lg-12 col-md-12 col-xs-12">
                    <div class="form-wizard">
                        ...
                        <form action="{{ route('paiement') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <fieldset class="wizard-fieldset">
                                ...
                                <div class="form-group">
                                    <label for="cin" class="wizard-form-text-label">CIN/PassPort :</label>
                                    <input type="text" id="cin" name="cin" class="form-control wizard-required"
                                        required>
                                </div>
                                <div class="form-group">
                                    <label for="photo" class="form-label">Photo récente :</label>
                                    <input type="file" id="photo" name="photo"
                                        accept=".jpeg,.jpg,.png,.pdf" class="form-control wizard-required"
                                        placeholder="Photo récente :" required title="Photo récente :">
                                </div>
                                <div class="form-group">
                                    <label for="face1" class="form-label">Photo CIN/Passport Face
                                        1:</label>
                                    <input type="file" id="face1" name="face1"
                                        accept=".jpeg,.jpg,.png,.pdf" class="form-control wizard-required"
                                        placeholder="Photo CIN/Passport Face 1" required>
                                </div>
                                <div class="form-group">
                                    <label for="face2" class="form-label"> Photo CIN/Passport Face
                                        2:</label>
                                    <input type="file" id="face2" name="face2"
                                        accept=".jpeg,.jpg,.png,.pdf" class="form-control wizard-required"
                                        placeholder="Photo CIN/Passport Face 2" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" id="reçu" name="recu" accept=".pdf,.jpeg,.jpg,.png"	
                                        class="form-control wizard-required" placeholder="Reçu de paiement" required>
                                </div>
                                <div class="form-group clearfix">
