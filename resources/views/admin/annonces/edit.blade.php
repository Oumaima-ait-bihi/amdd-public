        ...
        <div class="nk-content-inner">
            <div class="nk-content-body">
                ...
                <div class="mb-6">
                    ...
                    <p class="text-gray-600">Mettez à jour les détails de l'annonce ci-dessous.</p>
                </div>
                ...
                <form action="{{ route('admin.annonces.update', $annonce->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="space-y-12">
                        ...
                        <div class="border-b border-gray-900/10 pb-12">
                            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                ...
                                <div class="sm:col-span-3">
                                    ...
                                    <div class="mt-2">
                                        <input type="text" name="titre_annonce_fr" id="titre_annonce_fr" value="{{ old('titre_annonce_fr', $annonce->titre_annonce_fr) }}"
                                ...
                                <div class="sm:col-span-3">
                                    ...
                                    <div class="mt-2">
                                        <input type="text" name="titre_annonce_ar" id="titre_annonce_ar" value="{{ old('titre_annonce_ar', $annonce->titre_annonce_ar) }}"
                                            class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-200 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 transition-all duration-300 ease-in-out sm:text-sm/6"
                                ...
                                <div class="col-span-full">
                                    ...
                                    <div class="mt-2">
                                        <textarea name="description_annonce_fr" id="description_annonce_fr" rows="3"
                                            class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-200 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 transition-all duration-300 ease-in-out sm:text-sm/6"
                                            placeholder="Entrez une description en français">{{ old('description_annonce_fr', $annonce->description_annonce_fr) }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-span-full">
                                    ...
                                    <div class="mt-2">
                                        <textarea name="description_annonce_ar" id="description_annonce_ar" rows="3"
                                            class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-200 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 transition-all duration-300 ease-in-out sm:text-sm/6"
                                            dir="rtl" placeholder="أدخل وصفًا بالعربية">{{ old('description_annonce_ar', $annonce->description_annonce_ar) }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="border-b border-gray-900/10 pb-12">
                            ...
                            <p class="mt-1 text-sm/6 text-gray-600">Mettez à jour la date et l'image de l'annonce.</p>
                            ...
                            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                ...
                                <div class="sm:col-span-3">
                                    ...
                                    <div class="mt-2">
                                        <input type="date" name="date_annonce" id="date_annonce" value="{{ old('date_annonce', $annonce->date_annonce->format('Y-m-d')) }}"
                                ...
                                <div class="col-span-full">
                                    ...
                                    @if ($annonce->image_annonce)
                                        <div class="mt-2">
                                            <img src="{{ asset('storage/' . $annonce->image_annonce) }}" alt="Current Image" class="w-32 h-32 object-cover rounded mb-2">
                                    ...
                                    <div class="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10">
                                        <div class="text-center">
                                            ...
                                            <div class="mt-4 flex text-sm/6 text-gray-600">
                                                <label for="image_annonce" class="relative cursor-pointer rounded-md bg-white font-semibold text-indigo-600 focus-within:ring-2 focus-within:ring-indigo-600 focus-within:ring-offset-2 hover:text-indigo-500">
