    ...
    <div class="container-fluid">
        <div class="nk-content-inner">
            <div class="nk-content-body">
                <!-- Page Title -->
                <div class="mb-6">
                    <h2 class="text-2xl font-semibold text-gray-800">Ajouter une Nouvelle Activité</h2>
                    <p class="text-gray-600">Remplissez les champs ci-dessous pour créer une activité.</p>
                </div>
                ...
                <form action="{{ route('admin.activities.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="space-y-12">
                                ...
                                <div class="col-span-full">
                                    ...
                                    <div class="mt-2">
                                        <textarea name="description" id="description" rows="3"
                                            class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-200 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 transition-all duration-300 ease-in-out sm:text-sm/6"
                                            placeholder="Entrez une description de l'activité">{{ old('description') }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="border-b border-gray-900/10 pb-12">
                            ...
                            <p class="mt-1 text-sm/6 text-gray-600">Définissez les dates et le lien de l'activité.</p>
                        ...
                        <div class="border-b border-gray-900/10 pb-12">
                            ...
                            <p class="mt-1 text-sm/6 text-gray-600">Ajoutez une image principale et une vidéo pour l'activité.</p>
                    ...
                    <div class="mt-6 flex items-center justify-end gap-x-6">
                        ...
                        <button type="submit" class="rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Créer l'Activité</button>
                    </div>
                </form>
            </div>
        </div>
