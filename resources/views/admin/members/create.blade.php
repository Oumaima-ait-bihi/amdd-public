    ...
    <div class="container-fluid">
        <div class="nk-content-inner">
            <div class="nk-content-body">
                <!-- Page Title -->
                <div class="mb-6">
                    <h2 class="text-2xl font-semibold text-gray-800">Créer un Nouvel Membre</h2>
                    <p class="text-gray-600">Remplissez les champs ci-dessous pour ajouter un nouvel membre.</p>
                </div>
                ...
                <!-- Form -->
                <form action="{{ route('admin.members.store') }}" method="POST" class="space-y-8">
                    @csrf
                    <div class="border-b border-gray-900/10 pb-8">
                        <div class="grid grid-cols-1 gap-x-6 gap-y-6 sm:grid-cols-6">
                            ...
                            <!-- Confirm Password -->
                            <div class="sm:col-span-3">
                                <label for="password_confirmation" class="block text-sm font-medium text-gray-900">Confirmer le Mot de Passe</label>
                                <div class="mt-2">
                    ...
                    <div class="flex items-center justify-end gap-x-6">
                        ...
                        <button type="submit" class="rounded-md bg-indigo-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 outline-none">
                            Créer le Membre
                        </button>
                    </div>
                </form>
