        ...
        <div class="nk-content-inner">
            <div class="nk-content-body">
                ...
                <div class="mb-6">
                    ...
                    <p class="text-gray-600">Mettez à jour les détails de l'événement ci-dessous.</p>
                </div>
                ...
                <form action="{{ route('admin.evenements.update', $evenement->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="space-y-12">
                        ...
                        <div class="border-b border-gray-900/10 pb-12">
                            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                ...
                                <div class="sm:col-span-3">
                                    ...
                                    <div class="mt-2">
                                        <input type="text" name="titre_fr" id="titre_fr" value="{{ old('titre_fr', $evenement->titre_fr) }}"
                                ...
                                <div class="sm:col-span-3">
                                    ...
                                    <div class="mt-2">
                                        <input type="text" name="titre_ar" id="titre_ar" value="{{ old('titre_ar', $evenement->titre_ar) }}"
                                            class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-200 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 transition-all duration-300 ease-in-out sm:text-sm/6"
                                ...
                                <div class="sm:col-span-3">
                                    ...
                                    <div class="mt-2 grid grid-cols-1">
                                        <select name="type_fr" id="type_fr"
                                            ...
                                            <option value="Conference" {{ old('type_fr', $evenement->type_fr) === 'Conference' ? 'selected' : '' }}>Conférence</option>
                                            <option value="Workshop" {{ old('type_fr', $evenement->type_fr) === 'Workshop' ? 'selected' : '' }}>Atelier</option>
                                            <option value="Seminar" {{ old('type_fr', $evenement->type_fr) === 'Seminar' ? 'selected' : '' }}>Séminaire</option>
                                            <option value="Meetup" {{ old('type_fr', $evenement->type_fr) === 'Meetup' ? 'selected' : '' }}>Rencontre</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="sm:col-span-3">
                                    ...
                                    <div class="mt-2 grid grid-cols-1">
                                        <select name="type_ar" id="type_ar"
                                            class="col-start-1 row-start-1 w-full appearance-none rounded-md bg-white py-1.5 pr-8 pl-3 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-200 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 transition-all duration-300 ease-in-out sm:text-sm/6"
                                            required dir="rtl">
                                            <option value="" disabled>اختر نوعًا</option>
                                            <option value="Conference" {{ old('type_ar', $evenement->type_ar) === 'Conference' ? 'selected' : '' }}>مؤتمر</option>
                                            <option value="Workshop" {{ old('type_ar', $evenement->type_ar) === 'Workshop' ? 'selected' : '' }}>ورشة عمل</option>
                                            <option value="Seminar" {{ old('type_ar', $evenement->type_ar) === 'Seminar' ? 'selected' : '' }}>ندوة</option>
                                            <option value="Meetup" {{ old('type_ar', $evenement->type_ar) === 'Meetup' ? 'selected' : '' }}>لقاء</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-span-full">
                                    ...
                                    <div class="mt-2">
                                        <textarea name="description_fr" id="description_fr" rows="3"
                                            class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-200 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 transition-all duration-300 ease-in-out sm:text-sm/6"
                                            placeholder="Entrez une description en français">{{ old('description_fr', $evenement->description_fr) }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-span-full">
                                    ...
                                    <div class="mt-2">
                                        <textarea name="description_ar" id="description_ar" rows="3"
                                            class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-200 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 transition-all duration-300 ease-in-out sm:text-sm/6"
                                            dir="rtl" placeholder="أدخل وصفًا بالعربية">{{ old('description_ar', $evenement->description_ar) }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="border-b border-gray-900/10 pb-12">
                            ...
                            <p class="mt-1 text-sm/6 text-gray-600">Mettez à jour les dates et le statut de l'événement.</p>
                            ...
                            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                ...
                                <div class="sm:col-span-3">
                                    ...
                                    <div class="mt-2">
                                        <input type="date" name="date_debut" id="date_debut" value="{{ old('date_debut', $evenement->date_debut->format('Y-m-d')) }}"
                                ...
                                <div class="sm:col-span-3">
                                    ...
                                    <div class="mt-2">
                                        <input type="date" name="date_fin" id="date_fin" value="{{ old('date_fin', $evenement->date_fin->format('Y-m-d')) }}"
                                            class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-200 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 transition-all duration-300 ease-in-out sm:text-sm/6"
                                            required>
                                    </div>
                                </div>
                                ...
                                <div class="col-span-full">
                                    ...
                                    <div class="mt-2" id="links-container">
                                        @forelse ($evenement->links ?? [] as $index => $link)
                                            <div class="flex items-center gap-x-2 mb-2">
                                                <input type="url" name="links[]" value="{{ old('links.' . $index, $link) }}"
                                                    class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-200 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 transition-all duration-300 ease-in-out sm:text-sm/6"
                                                    placeholder="https://example.com">
                                                @if ($index === 0)
                                                    <button type="button" id="add-link" class="rounded-md flex items-center bg-indigo-600 px-2 py-1.5 text-sm font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                                    ...
                                    <p class="mt-3 text-sm/6 text-gray-600">Ajoutez ou supprimez des liens avec les boutons "+" et "−".</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="border-b border-gray-900/10 pb-12">
                            ...
                            <p class="mt-1 text-sm/6 text-gray-600">Mettez à jour l'image principale, la vidéo et la galerie.</p>
                            ...
                            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                ...
                                <div class="col-span-full">
                                    ...
                                    @if ($evenement->image)
                                        <div class="mt-2">
                                            <img src="{{ Storage::url($evenement->image) }}" alt="Current Image" class="w-32 h-32 object-cover rounded mb-2">
                                ...
                                <div class="col-span-full">
                                    ...
                                    @if ($evenement->gallery && !empty($evenement->gallery))
                                        <div class="mt-2 flex space-x-2 mb-4">
                                            @foreach ($evenement->gallery as $galleryImage)
                                                <img src="{{ Storage::url($galleryImage) }}" alt="Gallery Image" class="w-16 h-16 object-cover rounded">
                                            @endforeach
                                        </div>
                                        <p class="text-sm/6 text-gray-600">Galerie actuelle. Uploadez pour ajouter d'autres images.</p>
                                    @endif
                                    <div class="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10 gallery-drop-area" id="gallery-drop-area">
                                        <div class="text-center">
                                            ...
                                            <div class="mt-4 flex text-sm/6 text-gray-600">
                                                <label for="gallery" class="relative cursor-pointer rounded-md bg-white font-semibold text-indigo-600 focus-within:ring-2 focus-within:ring-indigo-600 focus-within:ring-offset-2 hover:text-indigo-500">
...
<script>
    ...
    document.getElementById('add-link').addEventListener('click', function() {
        ...
        newLinkDiv.className = 'flex items-center gap-x-2 mb-2';
